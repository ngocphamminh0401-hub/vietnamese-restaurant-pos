...
import { X, PackageOpen, Calendar, User, FileText } from 'lucide-react';
...
export const ExportDetailModal: React.FC<ExportDetailModalProps> = ({ isOpen, onClose, transaction }) => {
            ...
            <div className="bg-white rounded-xl shadow-2xl w-[900px] max-h-[90vh] overflow-hidden flex flex-col">
                ...
                <div className="bg-gradient-to-r from-red-600 to-red-700 text-white p-6 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-2xl font-bold">Chi tiết phiếu xuất</h2>
                            <p className="text-red-100 text-sm">Mã phiếu: {transaction.code}</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
                ...
                <div className="p-6 flex-1 overflow-y-auto">
                    ...
                    <div className="grid grid-cols-2 gap-6 mb-6 bg-gray-50 p-4 rounded-lg">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-xs text-gray-500">Lý do xuất</p>
                                <p className="font-semibold text-gray-800">{REASON_LABELS[transaction.reason] || transaction.reason}</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <p className="text-xs text-gray-500">Ngày xuất</p>
                        ...
                        <table className="w-full">
                            ...
                            <tfoot className="bg-gray-50 border-t-2 border-gray-300">
                                <tr>
                                    ...
                                    <td className="px-4 py-4 text-right font-bold text-red-600 text-xl">
